...
| **5. Phases.md** | 5-Phase hackathon development roadmap (Hours 0–120), workstream matrix, 48-hour compressed fallback cut-line, and open-source LiveKit voice deliverables. | [`Phases.md`](./docs/Phases.md) |
